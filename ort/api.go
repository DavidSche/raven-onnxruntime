...
type ortApi struct {
	...
	MemoryInfoGetDeviceMemType                          uintptr // 321
	MemoryInfoGetVendorId                               uintptr // 322
	ValueInfo_GetValueProducer                          uintptr // 323
	ValueInfo_GetValueNumConsumers                      uintptr // 324
	ValueInfo_GetValueConsumers                         uintptr // 325
	ValueInfo_GetInitializerValue                       uintptr // 326
	ValueInfo_GetExternalInitializerInfo                uintptr // 327
	ValueInfo_IsRequiredGraphInput                      uintptr // 328
	ValueInfo_IsOptionalGraphInput                      uintptr // 329
	ValueInfo_IsGraphOutput                             uintptr // 330
	ValueInfo_IsConstantInitializer                     uintptr // 331
	ValueInfo_IsFromOuterScope                          uintptr // 332
	Graph_GetName                                       uintptr // 333
	Graph_GetModelPath                                  uintptr // 334
	Graph_GetOnnxIRVersion                              uintptr // 335
	Graph_GetNumOperatorSets                            uintptr // 336
	Graph_GetOperatorSets                               uintptr // 337
	Graph_GetNumInputs                                  uintptr // 338
	Graph_GetInputs                                     uintptr // 339
	Graph_GetNumOutputs                                 uintptr // 340
	Graph_GetOutputs                                    uintptr // 341
	Graph_GetNumInitializers                            uintptr // 342
	Graph_GetInitializers                               uintptr // 343
	Graph_GetNumNodes                                   uintptr // 344
	Graph_GetNodes                                      uintptr // 345
	Graph_GetParentNode                                 uintptr // 346
	Graph_GetGraphView                                  uintptr // 347
	Node_GetId                                          uintptr // 348
	Node_GetName                                        uintptr // 349
	Node_GetOperatorType                                uintptr // 350
	Node_GetDomain                                      uintptr // 351
	Node_GetSinceVersion                                uintptr // 352
	Node_GetNumInputs                                   uintptr // 353
	Node_GetInputs                                      uintptr // 354
	Node_GetNumOutputs                                  uintptr // 355
	Node_GetOutputs                                     uintptr // 356
	Node_GetNumImplicitInputs                           uintptr // 357
	Node_GetImplicitInputs                              uintptr // 358
	Node_GetNumAttributes                               uintptr // 359
	Node_GetAttributes                                  uintptr // 360
	Node_GetAttributeByName                             uintptr // 361
	OpAttr_GetTensorAttributeAsOrtValue                 uintptr // 362
	OpAttr_GetType                                      uintptr // 363
	OpAttr_GetName                                      uintptr // 364
	Node_GetNumSubgraphs                                uintptr // 365
	Node_GetSubgraphs                                   uintptr // 366
...
// apiFuncs holds purego-bound Go functions
type apiFuncs struct {
	...
	setSessionExecutionMode               func(SessionOptionsHandle, ExecutionMode) StatusHandle
	enableMemPattern                      func(SessionOptionsHandle) StatusHandle
	disableMemPattern                     func(SessionOptionsHandle) StatusHandle
	setSessionGraphOptimizationLevel      func(SessionOptionsHandle, GraphOptimizationLevel) StatusHandle
	setIntraOpNumThreads                  func(SessionOptionsHandle, int32) StatusHandle
	setInterOpNumThreads                  func(SessionOptionsHandle, int32) StatusHandle
